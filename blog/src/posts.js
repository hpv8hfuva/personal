                            ...
                            {headlineBlog &&
                                <a href="post.html" class="flex w-full flex-wrap no-underline hover:no-underline">
                                    <div class="w-full md:w-2/3 rounded-t">
                                        <img src="https://source.unsplash.com/collection/325867/800x600" alt={headlineBlog.title} class="h-full w-full shadow" />
                                    </div>
                                ...
                                <>
                                        ...
                                        (< div class="w-full md:w-1/3 p-4 flex flex-col flex-grow flex-shrink" >
                                            <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
                                                <a href="/" class="flex flex-wrap no-underline hover:no-underline">
                                                    <img src="https://source.unsplash.com/collection/325867/800x600" alt={blog.title} class="h-64 w-full rounded-t pb-6" />
                                    ...
                                    {(index % 7 === 3 || index % 7 === 6) &&
                                        (< div class="w-full md:w-1/3 p-4 flex flex-col flex-grow flex-shrink">
                                            <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
                                                <a href="/" class="flex flex-wrap no-underline hover:no-underline">
                                                    <img src="https://source.unsplash.com/collection/325867/800x600" alt={blog.title} class="h-[20rem] w-full rounded-t pb-6" />
                                                    <p class="w-full text-gray-600 text-xs md:text-sm px-6">{blog.category}</p>
                                                    <div class="w-full font-bold text-xl text-gray-900 px-6">{blog.title}</div>
                                                    <p class="text-gray-800 font-serif text-base px-6 mb-5">
                                                        {blog.description}
                                    ...
                                    {(index % 7 === 4 || index % 7 === 5) &&
                                        (< div class="w-full md:w-2/3 p-4 flex flex-col flex-grow flex-shrink">
                                            <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
                                                <a href="/" class="flex flex-wrap no-underline hover:no-underline">
                                                    <img src="https://source.unsplash.com/collection/325867/800x600" alt={blog.title} class="h-[30rem] w-full rounded-t pb-6" />
                                                    <p class="w-full text-gray-600 text-xs md:text-sm px-6">{blog.category}</p>
                                                    <div class="w-full font-bold text-xl text-gray-900 px-6">{blog.title}</div>
                                                    <p class="text-gray-800 font-serif text-base px-6 mb-5">
                                                        {blog.description}
